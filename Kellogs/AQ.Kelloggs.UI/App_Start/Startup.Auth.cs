...
namespace AQ.Kelloggs.UI
{
    public partial class Startup
    {
        ...
        private static string aadTenant = ConfigurationManager.AppSettings["ida:AADTenant"];
...

        {
            ...
            if (env=="Dev")
            {
                ...
                new OpenIdConnectAuthenticationOptions
                {
                    ...
                    ClientId = appId,
                    Authority = /*String.Format(CultureInfo.InvariantCulture, aadInstance, "Kantar.onmicrosoft.com", "/v2.0")*/String.Format(CultureInfo.InvariantCulture, aadInstance, aadTenant, "v2.0"),
