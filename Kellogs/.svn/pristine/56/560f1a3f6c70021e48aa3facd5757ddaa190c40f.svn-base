...
namespace AQ.Kelloggs.Models
{
    ...
    public static class Constants
    {
        ...
        private const string businessReportData59 = "USP_BusinessReviewSlides59";
        //private const string businessReportData67 = "USP_BusinessReviewSlides67_Sabat";
        private const string businessReportData67 = "USP_BusinessReviewSlides67";
        ...
        public static string BusinessReportData59
        {
            get
            {
                return businessReportData59;
            }
        }
        public static string BusinessReportData67
        {
            get
            {
                return businessReportData67;
            }
        }
